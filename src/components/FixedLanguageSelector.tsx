  ...
  return (
    <div className="fixed bottom-6 left-6 z-50" ref={dropdownRef}>
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="flex items-center space-x-2 px-3 py-2 rounded-xl bg-white/90 backdrop-blur-md border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 text-gray-700 hover:text-primary-600"
      >
        <ReactCountryFlag
